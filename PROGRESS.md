...
- [ ] Прогнати seed на проді — **не зроблено, свідомо**: змінює дані на живій базі, користувач
      попросив спитати перед виконанням; питання лишилось відкритим наприкінці сесії (нижче)
