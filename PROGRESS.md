...
**Поточний етап: 7 (Order Detail закрито й відревʼюєно, далі — Поліш)** ← оновлювати в кінці кожної сесії
...
- `2026-09-04 14:20` — **Ревʼю Етапу 6 + виправлення всіх 13 знайдених пунктів.** Ревʼю робилось
  ...
  **(3)** етапи 4–6 **досі не задеплоєні**, прод на `6e7524f`, а БД уже пересіяна з новим полем —
  наступний деплой має піти разом із міграцією.
